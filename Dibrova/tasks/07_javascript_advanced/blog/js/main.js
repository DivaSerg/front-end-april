...
<div class="about-head">
    ...
    function createCreateArticle() {
        var template = `
<div class="about-head">
     <form>
        <input id="form-title" type="text" placeholder="title">
        <input id="form-text" type="text" placeholder="text">
        <input id="form-author" type="text" placeholder="author">
        <input id="form-photo" type="text" placeholder="photo">
     ...
     function renderCreateArticle() {
        ...
        aboutHolder.innerHTML = createCreateArticle();

        document.getElementById('form-submit').addEventListener("click", setInput);
    ...
    function setInput(e) {
        ...
        inpTitle = document.getElementById('form-title').value;

        inpText = document.getElementById('form-text').value;

        inpAuthor = document.getElementById('form-author').value;

        inpPhoto = document.getElementById('form-photo').value;

        obj.title = inpTitle;
        obj.text = inpText;
        obj.author = inpAuthor;
        obj.photo = inpPhoto;
